...
test("recovery codes contain 160 on-device random bits in a distinct format", () => {
  ...
  assert.equal(code, "CSVR-000G-40R4-0M30-E209-185G-R38E-1W81-24GK");
...
test("common, predictable, sequential, and repeated passwords remain a warned user choice", () => {
  for (const password of ["Password123!!!!", "P@ssw0rd1234567", "CircleSignal2026!!!", "recovery-password-123", "abcabcabcabcabc", "0123456789012345", "password password password password password"]) {
