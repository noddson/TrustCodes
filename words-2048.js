// Dictionary v1 uses the complete 2,048-word BIP-39 English list.
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
// Fixed order is part of the setup-code format. Never reorder it.
export const WORDS = `abandon ability able about above absent absorb abstract absurd abuse access accident account accuse achieve acid
...
wrap wreck wrestle wrist write wrong yard year yellow you young youth zebra zero zone zoo`.split(/\s+/);
