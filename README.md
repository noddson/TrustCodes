...
- A setup QR is as sensitive as its text setup code. It contains wrapped channel material and its salt, but never the context password.
...
- A context is closer to an additional password than a public cryptographic salt. Use a strong, memorable value if relying on it: someone with setup material and an observed valid code may be able to test context guesses offline.
